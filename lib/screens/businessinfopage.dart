                    ...
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final educationData = educationDocs[index].data()
                              as Map<String, dynamic>;
                          return ListTile(
                            title: Text(educationData['degree'] ?? ''),
                            subtitle: Text(
                                '${educationData['duration'] ?? ''} (${educationData['year'] ?? ''})'),
                          );
                        },
                      );
                    }
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          final experienceData = experienceDocs[index].data()
                              as Map<String, dynamic>;
                          return ListTile(
                            title: Text(experienceData['course'] ?? ''),
                            subtitle: Text(
                                '${experienceData['duration'] ?? ''} (${experienceData['from'] ?? ''} - ${experienceData['year'] ?? ''})'),
                          );
                        },
                      );
                    }
